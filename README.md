...
1. Произвести настройку переменных окружения - в папке `\Thesis_project` разметить файл .env со следующими параметрами:
...
2. В папке `\Thesis_project` выполнить команду:
```python
